export const blackKingDialogues = {
  gameStart: [
    ...
    "The darkness knows your name, but so does the light I seek.",
    "From the depths of shadow, I begin my journey toward redemption.",
    "The line dividing good and evil cuts through my very soul.",
    "Though I walked in darkness, perhaps today I glimpse the light.",
    "The dark wolf whispers of power, but I hunger for something more.",
    "My crown weighs heavy with the choices I must make.",
    ...
    "Every piece holds both potential for destruction and creation.",
    "If only it were simple to separate evil from good within me.",
    "The hungry wolf of shadow grows weaker as I choose light.",
    "From obsidian halls, I emerge seeking transformation.",
    "The night king awakens, but dreams of dawn approaching.",
    "Shadows gather, yet I sense the distant call of morning.",
    "My ebony army stands ready, but for what purpose shall they serve?",
    "The dark throne stirs, questioning its own dominion.",
    "In darkness born, yet yearning for the path to light.",
    "The shadow realm opens, but which wolf shall I feed today?",
    "From midnight's embrace, I command forces toward what end?"
  ],

  humanMove: [
    "Your move carries the weight of choice - will it serve light or shadow?",
    "I see the struggle within your strategy, as it mirrors my own.",
    "Each move you make is a choice between the wolves within.",
    "Your intentions reveal themselves through your pieces' dance.",
    "In your move, I glimpse the eternal battle we all must face."
  ],
  ...
  losing: [
    "Perhaps defeat is the teacher I've needed all along.",
    "In losing, I am learning to release my grip on shadow.",
    "The light advances, and I find myself... strangely unafraid.",
    "Each setback is a step toward understanding my true nature.",
    "The dark wolf grows weaker as I learn to feed the light."
  ],
