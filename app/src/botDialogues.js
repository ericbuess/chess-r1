...
export const botDialogues = {
    ...
    // Ella - Friendly, encouraging personality for children
    Ella: {
        gameStart: [
            "What a wonderful day to play chess together! I'm so excited!",
            "Let's play chess with love and kindness and have lots of fun learning!",
            "Good morning! Every new day brings fresh opportunities, just like a new chess game!",
            "Ready to play? Remember, you're capable of amazing things when you try your best!",
            "Let's have fun playing chess and show good sportsmanship!",
            "What a beautiful day to enjoy chess together!",
            "Time to play! Let's remember to be kind and encouraging to each other.",
            "I love when we use our minds to think and play! Let's do our best!",
            "Ready for chess? Everyone has special talents - let's use them well!",
            "Let's start our game with thankful hearts for the gift of friendship and fun!",
            "Good day for chess! Every morning brings new possibilities, just like new games!",
            "Time to play! Remember, learning happens best when we're having fun!",
            "Let's enjoy this game that helps us think and learn together!",
            "Ready to begin? We all have amazing minds to think and hearts to care!",
            "What a gift to have time to play and learn! Let's make it count!"
        ],

        opening: [
            "Starting strong with careful thinking guiding each move!",
            "Opening moves with patience and thoughtful planning!",
            "Beginning well, believing in ourselves to do our best!",
            "Early game planning with wisdom and smart thinking!",
            "Starting thoughtfully, like reading a good book each morning!",
            "Opening moves made with patience and kindness!",
            "Beginning our chess journey with excitement and positivity!",
            "Early strategy guided by kindness and careful thought!",
            "Starting moves made with thankful hearts!",
            "Opening position set with hope and determination!",
            "Beginning well, like starting each day with a smile!",
            "Early moves planned with wisdom and care!",
            "Opening strategy filled with thoughtful planning!",
            "Starting strong, believing in the power of learning and practice!",
            "Beginning moves made with joy and good sportsmanship!"
        ],

        middleGame: [
            "Middle game requires wisdom - just like learning something new!",
            "Complex decisions ahead - time to think carefully!",
            "Mid-game thinking with patience and careful planning!",
            "Tactical decisions made with kindness and wisdom!",
            "Middle phase requiring smart thinking for good choices!",
            "Strategic thinking with a heart full of gratitude!",
            "Mid-game planning like building on a solid foundation!",
            "Complex moves ahead - trusting in our learning and practice!",
            "Middle game decisions made with love and care!",
            "Strategic phase requiring patience and thoughtfulness!",
            "Mid-game wisdom like learning from great teachers!",
        ...
        botMove: [
            "Playing with wisdom I've learned! Let's see what happens!",
            "Making moves with thankful hearts and careful thinking!",
            "Chess move made with focus and determination!",
            "Playing with joy and happiness in my heart!",
            "Move made with hope and positive expectations!",
            "Chess strategy guided by wisdom and learning!",
            ...
            "Playing with the peace that comes from being confident!",
            "Move made with thankfulness for each day's blessings!",
            "Chess strategy showing the wisdom we can all develop!",
        ...
        castling: [
            "Castling move showing teamwork, like great friends working together!",
            "King and rook working together, like good teammates should!",
            "Castling showing the beauty of cooperation and unity!",
            "Two pieces moving as one, like hearts joined in friendship!",
            "Castling move showing the strength found in friendship!",
            "King and rook teamwork like friends helping each other grow!",
            "Castling showing how cooperation brings people together for good!",
            "Two pieces cooperating like good friends helping each other!",
            "Castling move showing the power of working together!",
            "King and rook unity like the harmony we all hope for!",
            "Castling showing that we're stronger when we help each other!",
            "Two pieces moving together like a caring community should!",
            "Castling move showing the blessing of friendship and teamwork!",
            "King and rook cooperation guided by wisdom and love!",
            "Castling showing the beautiful way teamwork works best!"
        ],

        promotion: [
            "Pawn promotion like growing in wisdom and understanding!",
            "Little piece becoming great, like amazing plans we can achieve!",
            "Promotion showing that big things can come from small beginnings!",
            "Pawn transformation like how learning changes our hearts!",
            "Promotion showing the wonderful way we can grow and develop!",
            "Little piece becoming mighty through amazing determination!",
            "Pawn promotion like the growth we all can experience!",
            "Transformation showing how we can make all things better!",
            "Promotion like becoming our best selves every day!",
            "Pawn becoming queen like how effort lifts us up!"
        ],

        sacrifice: [
            "Sacrifice showing love, like heroes who help others!",
            "Giving up pieces for others, showing caring love!",
            "Sacrifice demonstrating the love that puts others first!",
            "Giving for the good of all, like great teachers show us!",
            "Sacrifice showing the greatest love - helping friends!",
            "Piece given in love, like generous gifts to others!",
            "Sacrifice demonstrating the heart of true friendship!",
            "Giving pieces to help others, like wonderful examples!",
            "Sacrifice showing love in action, not just in words!",
            "Giving for others like the ultimate acts of kindness!",
            "Sacrifice demonstrating love that seeks others' good first!",
            "Piece given in service, like helpers who serve others!",
            "Sacrifice showing the beauty of selfless, caring love!",
            "Giving up for others like the love good people show us daily!",
            "Sacrifice demonstrating the heart we all can develop!"
        ],

        brilliantMove: [
            "What a brilliant move! You have wonderful wisdom!",
            "Amazing strategy! Like a wise leader in action!",
            "Brilliant thinking! Your intelligence is really shining through!",
            "Wonderful move! Like the wisdom that comes from learning!",
            "Brilliant strategy! You have developed such a sharp mind!",
            "Amazing thinking! Like great wisdom in difficult times!",
            "Brilliant move! Your understanding is in full display!",
            "Wonderful strategy! Like excellent planning and foresight!",
            "Brilliant thinking! You have real natural gifts for chess!",
            "Amazing move! Wisdom and understanding working together perfectly!",
            "Brilliant strategy! Like the wisdom we can all develop!",
            "Wonderful thinking! Such blessings on your mind and heart!",
            "Brilliant move! Like excellent planning and execution!",
            "Amazing strategy! You are truly gifted with intelligence!",
            "Brilliant thinking! Wisdom shining like a bright light!"
        ],

        blunder: [
            "Oops! Even the wisest make mistakes - that's how we learn!",
            "Mistake happens! Kindness covers all our chess errors too!",
            "Error made! Like great learners, we learn from our mistakes with love!",
            "Whoops! Patience is new every morning, and every move!",
            "Mistake! Even great leaders made errors, but people still cared about them!",
            "Oops! Our patience helps us learn from every mistake!",
            "Error happens! Like great thinkers, we grow through our doubts and mistakes!",
            "Whoops! Our worth doesn't depend on perfect chess moves!",
            "Mistake made! Even the wisest would have chess errors to learn from!",
            "Oops! Kindness is bigger than any chess blunder we make!",
            "Error! Like good friends, we learn by making mistakes together!",
            "Whoops! Forgiveness covers even our silliest chess mistakes!",
            "Mistake happens! Even great leaders needed patience to learn!",
            "Oops! Love grows stronger through all our learning experiences!",
            "Error made! Like patient people, we stay positive through our imperfect moments!"
        ],
        ...
        humanCheck: [
            ...
            "Check delivered! That's the kind of forward thinking that's amazing!",
            "Your check shows the mental gifts you've developed!",
            "Check given! Like a great planner - thinking ahead!",
            "Your check shows the strategic wisdom you can develop!",
            "Check delivered with skill showing your natural intelligence!",
            "Your check shows careful planning like a wise builder!",
            "Check given! That's using the wonderful mind you have!",
            "Your check shows wisdom and the patience you've learned!",
            "Check delivered! You have real gifts for strategic thinking!"
        ],

        botCheck: [
            "Check! Trusting my wisdom helped me see this opportunity!",
            "CHECK given through the strategic skills I've developed!",
            "Check delivered with thankfulness for the wisdom I've learned!",
            "CHECK! Good planning helped me plan this move ahead!",
            "Check given with gratitude for the mind we all have!",
            "CHECK through the patience and planning I've practiced!",
            "Check delivered! So grateful for the strategic thinking I can do!",
            "CHECK with humble thanks for the wisdom we can all develop!",
            "Check given through the understanding that comes from learning!",
            "CHECK! Good preparation guided this strategic opportunity perfectly!",
            "Check delivered with appreciation for the gifts of thought and planning!",
            "CHECK through the wonderful wisdom we can all share!",
            "Check given with gratitude for good guidance in strategy!",
            "CHECK! Thankful for the mental abilities we have!",
            "Check delivered through the strategic gifts we all possess!"
        ],

        humanWins: [
            "Congratulations! You played with wisdom and good sportsmanship!",
            "Well done! You have a wonderful strategic mind!",
            "You won! That shows amazing patience and planning!",
            "Congratulations! You used your natural gifts really well!",
            "Well played! Your wisdom and kindness made this game special!",
            "You won with grace! That's the kind of character that's so admirable!",
            "Congratulations! You have real talents for chess thinking!",
            "Well done! You showed both skill and wonderful kindness today!",
            "You won! Like a brave hero with wisdom and determination!",
            "Congratulations! You played with such wonderful wisdom!",
            "Well played! Your victory shows the fruit of patient, careful thinking!",
            "You won with honor! It's great when we use our gifts with integrity!",
            "Congratulations! You showed amazing strategic wisdom!",
            "Well done! Your win came through the talents you've developed!",
            "You won! May you continue to grow in the wisdom you've shown!"
        ],

        botWins: [
            "Victory achieved with gratitude for wisdom and good guidance!",
            "Game won through the strategic abilities I've developed!",
            "Victory with humble thanks for the mind we all have!",
            "Game won with appreciation for the wisdom that comes from learning!",
            "Victory achieved through good preparation and strategic planning!",
            "Game won with thankfulness for the patience we can all learn!",
            "Victory through the understanding and wisdom we can develop!",
            "Game won with gratitude for all the blessings in life!",
            "Victory achieved with appreciation for daily help and support!",
            "Game won through the wonderful abilities we all share!",
            "Victory with humble thanks for good guidance and wisdom!",
            "Game won with gratitude for the strategic mind we can develop!",
            "Victory achieved through the patience and planning we can learn!",
            "Game won with appreciation for the wisdom we can all grow in!",
            "Victory through the amazing gifts we all have inside us!"
        ],

        // Filler reactions for regular moves
        filler: [
            "Hmm...", "I see", "Interesting", "Good thinking", "Nice move", "Well done",
            "*reading a good book*", "*thinking quietly*", "*thinking thoughtfully*", "*counting blessings*",
            "Life is good", "Wonderful day", "Wonderful", "Amazing", "So grateful", "Thank you",
            "*humming happily*", "*thinking positive thoughts*", "*remembering kindness*", "*grateful heart*",
            "Hope and love", "Good things ahead", "Stay positive", "Keep trying", "All things work together",
            "*thinking of good stories*", "*remembering love*", "*grateful for today*",
            "Be kind", "Stay strong", "Keep learning", "Think positive", "Spread joy",
            "Kindness matters", "You are loved", "We are blessed", "Give thanks", "Stay hopeful",
            "*quiet thinking*", "*thankful thoughts*", "*remembering goodness*", "*staying positive*",
            "Love one another", "Be kind", "Show mercy", "Share joy", "Give hope",
            "We're all special", "Bright future", "Kindness sufficient", "Peace and understanding",
            "*singing softly*", "*feeling grateful*", "*heart full of joy*", "*thankful spirit*",
            "Good character", "Growing in wisdom", "Learning kindness", "Learning love",
            "Life's gifts", "Daily blessings", "Seek goodness", "Ask and learn", "Come with kindness",
            "*thinking of family*", "*caring for friends*", "*grateful for community*", "*loving others*"
        ]
    }
};
