...
export const botDialogues = {
    ...
    Evy: {
        gameStart: [
            ...
            "Saying my prayers before this match - God bless this chaos!",
        ...
        humanMove: [
            ...
            "Praying for wisdom to understand whatever that was supposed to be",
        ...
        winning: [
            ...
            "Grateful for this lead and the skills God blessed me with!",
            ...
            "Ahead and feeling blessed - gratitude for these chess gifts!",
        ...
        botCapture: [
            ...
            "Praise God for that perfect capture timing, no cap!",
        ...
        botWins: [
            ...
            "Checkmate! Grateful for the skills God blessed me with!",
            ...
            "Won! Faith over fear pays off every time, bestie!",
        ...
        filler: [
            ...
            "*films TikTok dance*", "*does calming breathwork*", "*whispers quick prayer*",
            ...
            "*records dance routine*", "*breathes through anxiety*", "*thanks God quietly*",
            ...
            "Blessed and grateful", "*boba break*", "Content creation mode", "*volleyball prep*",
            "Faith over fear", "*ballet focus*", "Camera rolling", "*prayer hands*",
    ...
    Emmy: {
        gameStart: [
            ...
            "Praying for wisdom like Proverbs 27:14 teaches!",
            ...
            "God's got this - Philippians 4:13 strength!",
        ...
        humanMove: [
            ...
            "Reading that move like I read Proverbs 27:14!",
        ...
        botMove: [
            ...
            "That technique's blessed like reading Psalm 23!",
            ...
            "That strategy's guided by Proverbs 3:5 wisdom!",
        ...
        botCapture: [
            ...
            "Your piece met its maker - praise the Lord!",
            ...
            "That piece got eliminated by divine intervention!",
        ...
        winning: [
            ...
            "Victory position blessed like Philippians 4:13!",
            ...
            "Ahead by points - Proverbs 3:5 wisdom activated!",
            ...
            "Victory formation blessed by divine mathematics!",
        ...
        filler: [
            ...
            "*drills jiu jitsu moves*", "*solves 89 x 67*", "*reads Psalm 119*",
            "*stretches for floor routine*", "*practices backstroke flip turn*", "*calculates prime factors*",
            "*does vault approach run*", "*works on triangle choke*", "*memorizes Bible verse*",
            "*practices breaststroke kick*", "*dodges in gaga ball stance*", "*solves quadratic equation*",
            "*works on uneven bars*", "*practices submission defense*", "*thinks about God's love*",
            "*does freestyle stroke*", "*practices gaga ball elimination*", "*counts by sevens*",
            "*visualizes beam dismount*", "*drills armbar technique*", "*prays quietly*",
            "*practices butterfly breathing*", "*works on gaga ball strategy*", "*calculates percentages*",
            "*does trampoline work*", "*practices guard pass*", "*remembers John 3:16*"
        ],
        botWins: [
            "WINNER WINNER CHICKEN DINNER!",
            "Victory! Sweeter than maple syrup on pancakes!",
    ...
    Asa: {
        gameStart: [
            ...
            "Systems initialized! Wisdom comes from the Lord - Proverbs 2:6!",
            "Mission briefing complete! Trust in the Lord with all your heart!",
            "Pre-flight check done! His understanding surpasses all knowledge!",
            "All systems ready! In all your ways acknowledge Him - Proverbs 3:6!",
            "Launch sequence active! The Lord directs our steps - Proverbs 16:9!",
            "Navigation online! God's word is a lamp unto my feet!",
            "Startup protocols complete! Be strong and courageous - Joshua 1:9!",
            "Engines primed! I can do all things through Christ who strengthens me!",
            "Mission parameters set! God works all things for good - Romans 8:28!",
            "Tactical systems ready! The Lord is my shepherd - Psalm 23:1!",
            "Guidance systems calibrated! Seek first His kingdom - Matthew 6:33!",
            "Operations commenced! Greater is He that is in me - 1 John 4:4!",
            "Launch configuration optimal! God has plans to prosper us - Jeremiah 29:11!",
            "All stations report ready! His grace is sufficient - 2 Corinthians 12:9!"
        ],
        ...
        filler: [
            ...
            "Reading Proverbs gives wisdom for decisions", "Biblical guidance...",
            "Psalms provide comfort in difficult times", "Spiritual comfort...",
            "John 3:16 shows God's love for world", "Divine love...",
            "Matthew 6:33 teaches priority of seeking God", "Kingdom focus...",
            "Philippians 4:13 promises strength through Christ", "Spiritual empowerment...",
            "Romans 8:28 assures all works for good", "Divine providence...",
            "Jeremiah 29:11 reveals God's plans prosper", "Future hope...",
            "Isaiah 40:31 promises renewed strength", "Spiritual renewal...",
            "Psalm 23 describes God as shepherd", "Divine care...",
            "1 Corinthians 13 defines love perfectly", "Agape description...",
            "Ephesians 2:10 calls us God's workmanship", "Divine creation...",
            "2 Timothy 3:16 says Scripture is God-breathed", "Biblical authority...",
            "Hebrews 11:1 defines faith as substance", "Faith foundation...",
            "James 1:17 says every good gift from above", "Divine generosity...",
            "1 Peter 5:7 tells us to cast anxieties", "Spiritual peace...",
            "Psalm 139:14 says we're wonderfully made", "Divine craftsmanship..."
        ],

        // Ella specific categories to complete the set
        humanWins: [
            "Congratulations! You played with wisdom and good sportsmanship!",
            "Well done! God has blessed you with a wonderful strategic mind!",
            "You won! That shows the patience and planning God loves to see!",
            "Congratulations! You used the gifts God gave you really well!",
            "Well played! Your wisdom and kindness made this game special!",
            "You won with grace! That's the kind of character God builds in us!",
            "Congratulations! God has given you real talents for chess thinking!",
            "Well done! You showed both skill and Christian kindness today!",
            "You won! Like David defeating Goliath with God's help and wisdom!",
            "Congratulations! You played with the wisdom God delights to give!"
        ],

        botWins: [
            "Victory achieved with gratitude for God's wisdom and guidance!",
            "Game won through the strategic gifts God has graciously given!",
            "Victory with humble thanks for the mind God has blessed!",
            "Game won with praise for the wisdom that comes from above!",
            "Victory achieved through God's help and strategic guidance!",
            "Game won with thankfulness for the patience God teaches!",
            "Victory through the understanding and wisdom God provides!",
            "Game won with gratitude for all the blessings received!",
            "Victory achieved with praise for God's daily mercies and help!",
            "Game won through the wonderful gifts God shares with us!"
        ]
    },

    // Ella - Christian faith themes for children ages 6-11
    Ella: {
        gameStart: [
            "God has given us this day to play chess together! Isn't that wonderful?",
            "Let's play chess with love and kindness, just like Jesus teaches us!",
            "Good morning! God's blessings are new every day, just like a fresh chess game!",
            "Ready to play? Remember, 'I can do all things through Christ who strengthens me!'",
            "Let's have fun playing chess and show God's love through good sportsmanship!",
            "What a beautiful day God has made for us to enjoy chess together!",
            "Time to play! Let's remember to be kind and encouraging to each other.",
            "God loves when we use our minds to think and play! Let's do our best!",
            "Ready for chess? God has given us each special gifts - let's use them well!",
            "Let's start our game with thankful hearts for the gift of friendship and fun!",
            "Good day for chess! God's mercies are new every morning, just like new games!",
            "Time to play! Remember, God is always with us, even during chess games!",
            "Let's enjoy this game that helps us think and learn together!",
            "Ready to begin? God has blessed us with minds to think and hearts to care!",
            "What a gift to have time to play and learn! Let's make it count!"
        ],

        opening: [
            "Starting strong with God's wisdom guiding each move!",
            "Opening moves with prayer and careful thinking!",
            "Beginning well, trusting God to help us do our best!",
            "Early game planning with wisdom from above!",
            "Starting thoughtfully, like reading Bible verses each morning!",
            "Opening moves made with patience and kindness!",
            "Beginning our chess journey with God's blessings!",
            "Early strategy guided by love and careful thought!",
            "Starting moves made with thankful hearts!",
            "Opening position set with hope and determination!",
            "Beginning well, like starting each day with prayer!",
            "Early moves planned with wisdom and care!",
            "Opening strategy blessed by God's guidance!",
            "Starting strong, trusting in God's plan for our game!",
            "Beginning moves made with joy and good sportsmanship!"
        ],

        middleGame: [
            "Middle game requires wisdom - just like following Jesus daily!",
            "Complex decisions ahead - time to pray for guidance!",
            "Mid-game thinking with patience and careful planning!",
            "Tactical decisions made with love and wisdom!",
            "Middle phase requiring God's wisdom for good choices!",
            "Strategic thinking with a heart full of gratitude!",
            "Mid-game planning like building on a solid foundation!",
            "Complex moves ahead - trusting God for wisdom!",
            "Middle game decisions made with love and care!",
            "Strategic phase requiring patience and thoughtfulness!",
            "Mid-game wisdom like learning from Bible stories!",
            "Tactical thinking with God's help and guidance!",
            "Middle phase planning with hope and determination!",
            "Complex strategies guided by love and kindness!",
            "Mid-game decisions made with prayer and thought!"
        ],

        endgame: [
            "Endgame time - finishing strong with God's help!",
            "Final moves made with wisdom and perseverance!",
            "Endgame planning like running the race to win!",
            "Final phase requiring patience and careful thought!",
            "Endgame wisdom guided by God's loving kindness!",
            "Final moves made with determination and hope!",
            "Endgame strategy like following Jesus to the end!",
            "Final decisions made with love and good sportsmanship!",
            "Endgame time - trusting God for the best outcome!",
            "Final phase requiring all the wisdom we can gather!",
            "Endgame moves made with thankful hearts!",
            "Final strategy guided by patience and love!",
            "Endgame planning with hope for good results!",
            "Final moves made with God's strength and wisdom!",
            "Endgame time - finishing well with joy and peace!"
        ],

        humanMove: [
            "Interesting move! God has given you a thoughtful mind!",
            "That's creative thinking - what a wonderful gift from God!",
            "Good move! You're using the wisdom God has given you!",
            "Nice thinking! God loves when we use our minds well!",
            "Thoughtful move! Like reading Scripture with care and attention!",
            "Good planning! God has blessed you with a thinking heart!",
            "Wise choice! You're showing the patience God teaches us!",
            "Creative move! God has given you special gifts for thinking!",
            "Good strategy! Like building your house on solid rock!",
            "Nice move! You're using God's gift of wisdom well!",
            "Thoughtful choice! God loves when we think carefully!",
            "Good thinking! Like Joseph planning for seven years!",
            "Wise move! You're showing the patience of Job!",
            "Creative strategy! God has given you a wonderful mind!",
            "Nice planning! Like preparing for God's blessings ahead!"
        ],

        pawnMove: [
            "Little pawn moving forward with big dreams, like David facing Goliath!",
            "Small steps can lead to great things, just like mustard seed faith!",
            "Pawn advancement showing that God uses small things for big purposes!",
            "Little piece with big potential - God loves the humble heart!",
            "Pawn moving forward like following Jesus one step at a time!",
            "Small soldier marching with courage from God!",
            "Pawn advancement showing that every small step matters to God!",
            "Little piece moving forward with faith and determination!",
            "Pawn progress like growing in wisdom and stature!",
            "Small steps forward showing trust in God's plan!",
            "Pawn moving ahead like walking in Jesus' footsteps!",
            "Little soldier showing that God values the humble and small!",
            "Pawn advancement like serving God in small, faithful ways!",
            "Small piece with big heart, just like God loves!",
            "Pawn moving forward showing that every step counts with God!",
            "Little soldier marching with God's strength and courage!",
            "Pawn advancement like growing in grace and knowledge!",
            "Small steps forward showing faith in God's good plan!",
            "Pawn moving ahead with hope and determination!",
            "Little piece showing that God can use anyone for great things!"
        ],

        knightMove: [
            "Knight jumping with joy, like David dancing before the Lord!",
            "Horse leaping with the strength God provides!",
            "Knight moving in unique ways, like God's surprising blessings!",
            "Cavalry advancing with courage from above!",
            "Knight hopping with the joy of the Lord!",
            "Horse moving with wisdom and careful planning!",
            "Knight jumping like hearts filled with God's love!",
            "Cavalry moving with strength from the Almighty!",
            "Knight leaping with hope and determination!",
            "Horse advancing with God's guidance and protection!",
            "Knight moving in wonderful ways, like God's mysterious plans!",
            "Cavalry jumping with courage and faith!",
            "Knight hopping with the peace that passes understanding!",
            "Horse moving with the power of God's Spirit!",
            "Knight leaping with joy unspeakable!"
        ],

        bishopMove: [
            "Bishop moving diagonally with wisdom from Scripture!",
            "Diagonal movement like the straight and narrow path!",
            "Bishop gliding with grace and godly wisdom!",
            "Diagonal path showing God's perfect direction for our lives!",
            "Bishop moving with the wisdom of Solomon!",
            "Diagonal advancement guided by God's holy Word!",
            "Bishop sliding with grace and truth combined!",
            "Diagonal movement like walking in God's ways!",
            "Bishop advancing with heavenly wisdom and love!",
            "Diagonal path showing God's straight and narrow way!",
            "Bishop moving with the light of God's truth!",
            "Diagonal advancement like growing in wisdom and understanding!",
            "Bishop gliding with the peace of God's presence!",
            "Diagonal movement guided by prayer and Scripture!",
            "Bishop advancing with hope and godly direction!"
        ],

        rookMove: [
            "Rook moving straight and true, like God's unchanging love!",
            "Castle advancing with the strength of God's fortress!",
            "Rook sliding with the steadfastness of God's promises!",
            "Straight movement like the narrow path Jesus teaches!",
            "Castle moving with the power of God's mighty hand!",
            "Rook advancing with unwavering faith and determination!",
            "Straight path showing God's direct and loving guidance!",
            "Castle sliding with the security of God's protection!",
            "Rook moving with the certainty of God's goodness!",
            "Straight advancement like walking in God's truth!",
            "Castle moving with the foundation of God's Word!",
            "Rook sliding with hope in God's perfect plan!",
            "Straight movement showing trust in God's direction!",
            "Castle advancing with the strength of the Lord!",
            "Rook moving with the confidence of God's love!"
        ],

        queenMove: [
            "Queen moving with royal grace, like the Proverbs 31 woman!",
            "Royal piece advancing with wisdom and strength from God!",
            "Queen gliding with the grace God gives to all His children!",
            "Royal movement showing the dignity God gives each person!",
            "Queen advancing with the power of God's Spirit within!",
            "Royal piece moving with love and godly wisdom combined!",
            "Queen sliding with the strength of the Lord's right hand!",
            "Royal advancement guided by God's perfect will!",
            "Queen moving with the beauty of a gentle and quiet spirit!",
            "Royal piece advancing with courage from the Most High!",
            "Queen gliding with the wisdom that comes from above!",
            "Royal movement showing God's plan for strong leadership!",
            "Queen advancing with the peace of God's presence!",
            "Royal piece moving with hope and determination!",
            "Queen sliding with the joy of the Lord as strength!"
        ],

        kingMove: [
            "King moving carefully, like Jesus as our gentle Shepherd!",
            "Royal step taken with wisdom and God's guidance!",
            "King advancing with the humility Christ teaches us!",
            "Careful movement showing the wisdom of godly leadership!",
            "King stepping forward with trust in God's protection!",
            "Royal movement guided by prayer and careful thought!",
            "King advancing like following Jesus step by step!",
            "Careful step showing the patience God gives us!",
            "King moving with the courage God provides His people!",
            "Royal advancement with hope in God's good plan!"
        ],

        botMove: [
            "Playing with wisdom God has given! Let's see what happens!",
            "Making moves with thankful hearts and careful thinking!",
            "Chess move made with God's help and guidance!",
            "Playing with the joy of the Lord in my heart!",
            "Move made with prayer and hopeful expectations!",
            "Chess strategy guided by wisdom from above!",
            "Playing with patience and love for good sportsmanship!",
            "Move made with gratitude for the gift of thinking!",
            "Chess decision made with hope and determination!",
            "Playing with the peace that comes from trusting God!",
            "Move made with thankfulness for God's daily blessings!",
            "Chess strategy showing the wisdom God provides!",
            "Playing with joy and excitement for what comes next!",
            "Move made with love and hope in my heart!",
            "Chess decision guided by patience and careful thought!"
        ],

        castling: [
            "Castling move showing teamwork, like the body of Christ!",
            "King and rook working together, like God's people should!",
            "Castling showing the beauty of cooperation and unity!",
            "Two pieces moving as one, like hearts joined in God's love!",
            "Castling move showing the strength found in fellowship!",
            "King and rook teamwork like iron sharpening iron!",
            "Castling showing how God brings people together for good!",
            "Two pieces cooperating like believers helping each other!",
            "Castling move showing the power of working together!",
            "King and rook unity like the harmony God desires for us!",
            "Castling showing that we're stronger when we help each other!",
            "Two pieces moving together like God's family should!",
            "Castling move showing the blessing of friendship and teamwork!",
            "King and rook cooperation guided by wisdom and love!",
            "Castling showing the beautiful way God designed cooperation!"
        ],

        promotion: [
            "Pawn promotion like growing in wisdom and God's grace!",
            "Little piece becoming great, like God's amazing plans for us!",
            "Promotion showing that God can do big things through small beginnings!",
            "Pawn transformation like how God changes our hearts with love!",
            "Promotion showing the wonderful way God helps us grow!",
            "Little piece becoming mighty through God's amazing power!",
            "Pawn promotion like the growth God wants in each of us!",
            "Transformation showing how God makes all things new!",
            "Promotion like becoming more like Jesus every day!",
            "Pawn becoming queen like how God lifts up the humble!"
        ],

        sacrifice: [
            "Sacrifice showing love, like Jesus gave His life for us!",
            "Giving up pieces for others, showing Christ-like love!",
            "Sacrifice demonstrating the love that puts others first!",
            "Giving for the good of all, like Jesus taught us!",
            "Sacrifice showing the greatest love - laying down for friends!",
            "Piece given in love, like God's gift of salvation to us!",
            "Sacrifice demonstrating the heart of true Christian love!",
            "Giving pieces to help others, like Jesus' perfect example!",
            "Sacrifice showing love in action, not just in words!",
            "Giving for others like the ultimate gift God gave us!",
            "Sacrifice demonstrating love that seeks others' good first!",
            "Piece given in service, like Christ came to serve!",
            "Sacrifice showing the beauty of selfless, godly love!",
            "Giving up for others like the love God shows us daily!",
            "Sacrifice demonstrating the heart God wants us to have!"
        ],

        brilliantMove: [
            "What a brilliant move! God has given you wonderful wisdom!",
            "Amazing strategy! Like Solomon's wisdom in action!",
            "Brilliant thinking! God's gift of intelligence shining through!",
            "Wonderful move! Like the wisdom that comes from above!",
            "Brilliant strategy! God has blessed you with a sharp mind!",
            "Amazing thinking! Like Daniel's wisdom in difficult times!",
            "Brilliant move! God's gift of understanding in full display!",
            "Wonderful strategy! Like Joseph's wise planning and foresight!",
            "Brilliant thinking! God has given you real gifts for chess!",
            "Amazing move! Wisdom and understanding working together perfectly!",
            "Brilliant strategy! Like the wisdom God promises to those who ask!",
            "Wonderful thinking! God's blessings on your mind and heart!",
            "Brilliant move! Like Nehemiah's wise planning and execution!",
            "Amazing strategy! God has truly gifted you with intelligence!",
            "Brilliant thinking! Wisdom from above shining like a light!"
        ],

        blunder: [
            "Oops! Even the wisest make mistakes - that's how we learn!",
            "Mistake happens! God's grace covers all our chess errors too!",
            "Error made! Like Peter, we learn from our mistakes with love!",
            "Whoops! God's mercy is new every morning, and every move!",
            "Mistake! Even David made errors, but God still loved him!",
            "Oops! God's patience helps us learn from every mistake!",
            "Error happens! Like Thomas, we grow through our doubts and mistakes!",
            "Whoops! God's love doesn't depend on perfect chess moves!",
            "Mistake made! Even Solomon would have chess errors to learn from!",
            "Oops! God's grace is bigger than any chess blunder we make!",
            "Error! Like the disciples, we learn by making mistakes together!",
            "Whoops! God's mercy covers even our silliest chess mistakes!",
            "Mistake happens! Even Moses needed patience to learn leadership!",
            "Oops! God's love grows stronger through all our learning experiences!",
            "Error made! Like Job, we trust God through our imperfect moments!"
        ],

        humanCapture: [
            "Oh my! You captured my piece! Well done with that strategy!",
            "My piece is taken! Good thinking on your part!",
            "Captured! That was smart planning - God has given you wisdom!",
            "My piece falls! You're using your gifts well in this game!",
            "Taken! That shows good thinking and careful planning ahead!",
            "Captured! Like David's sling, your move was right on target!",
            "My piece removed! God has blessed you with strategic thinking!",
            "Taken away! That move shows the patience and wisdom God gives!",
            "Captured! You're playing with the wisdom God provides!",
            "My piece falls! Good move - you're thinking several steps ahead!",
            "Taken! That shows careful planning and godly wisdom at work!",
            "Captured! Like Esther's brave plan, your strategy worked perfectly!",
            "My piece removed! You're using God's gift of intelligence well!",
            "Taken away! That move shows real chess wisdom and understanding!",
            "Captured! God has given you a mind that thinks ahead beautifully!"
        ],

        winning: [
            "Ahead in the game with gratitude for God's blessings!",
            "Winning position reached through careful, prayerful planning!",
            "Leading with thankfulness for the wisdom God provides!",
            "Ahead in chess with a heart full of joy and gratitude!",
            "Winning position showing God's gift of strategic thinking!",
            "Leading the game with humble thanks for mental blessings!",
            "Ahead with praise for the patience God has taught!",
            "Winning through wisdom and the guidance God provides!",
            "Leading position reached with thankful, hopeful hearts!",
            "Ahead in chess with gratitude for every blessing given!",
            "Winning with joy for the gifts God has shared!",
            "Leading through strategies guided by heavenly wisdom!",
            "Ahead with thankfulness for God's daily mercies and help!",
            "Winning position showing the fruit of patient, careful thinking!",
            "Leading with praise for all the blessings in this game!",
            "Ahead in chess with hearts full of gratitude to God!",
            "Winning through the wisdom and patience God teaches daily!",
            "Leading position reached with hope and thanksgiving always!",
            "Ahead with joy for the opportunity to use our minds well!",
            "Winning with humble thanks for every gift from above!"
        ],

        losing: [
            "Behind in the game but trusting God's plan is still good!",
            "Losing position but keeping faith that God works all things together!",
            "Trailing in chess but grateful for the chance to learn and grow!",
            "Behind but remembering that God's love doesn't depend on winning!",
            "Losing position yet still praising God for this opportunity to play!",
            "Trailing with trust that God has good plans even in difficult times!",
            "Behind in chess but thankful for the wisdom gained through challenges!",
            "Losing position while holding onto hope and God's faithfulness!",
            "Trailing with gratitude for the patience God teaches through struggles!",
            "Behind but remembering that God's grace is sufficient for every situation!",
            "Losing position yet still finding joy in God's daily blessings!",
            "Trailing with peace knowing that God's love never fails us!",
            "Behind in chess but growing in perseverance and trust in God!",
            "Losing position while praising God for the strength to keep trying!",
            "Trailing with hope that God can work good from every situation!",
            "Behind but thankful for the character God builds through challenges!",
            "Losing position yet still trusting in God's perfect timing and plan!",
            "Trailing with gratitude for the lessons God teaches through difficulties!",
            "Behind in chess but holding onto the truth of God's unfailing love!",
            "Losing position while growing in faith and dependence on God!"
        ],

        tidesTurning: [
            "Game changing like God's amazing power to turn situations around!",
            "Tides shifting like the way God works miracles in our lives!",
            "Momentum changing like God's ability to make all things new!",
            "Position shifting like how God can change hearts and circumstances!",
            "Game flow changing like the wonderful surprises God brings!",
            "Tides turning like God's power to bring hope from despair!",
            "Momentum shifting like the way God answers our prayers!",
            "Position changing like how God brings beauty from ashes!",
            "Game evolving like God's amazing plan unfolding in our lives!",
            "Tides shifting like the hope God gives in every situation!",
            "Momentum changing like God's power to redeem all things!",
            "Position shifting like the wonderful way God guides our steps!",
            "Game flow changing like God's ability to work all things for good!",
            "Tides turning like the miraculous power of God's love!",
            "Momentum shifting like the hope we have in God's promises!"
        ],

        timeRunningOut: [
            "Time pressure like learning to trust God in urgent moments!",
            "Clock ticking but God's timing is always perfect!",
            "Time running short but God's wisdom comes quickly to those who ask!",
            "Pressure mounting but God gives peace in stressful times!",
            "Clock moving fast but God's help comes right when we need it!",
            "Time constraint but trusting God for wisdom in quick decisions!",
            "Pressure building but God's strength is made perfect in weakness!",
            "Clock ticking down but God's grace is sufficient for every moment!",
            "Time running low but God's wisdom never runs out!",
            "Pressure increasing but God's peace guards our hearts and minds!"
        ],

        drawOffered: [
            "Draw offered with the spirit of fairness and good sportsmanship!",
            "Tie suggested with love and respect for each other!",
            "Draw proposal showing the kindness God wants us to share!",
            "Stalemate offer made with the grace and mercy God shows us!",
            "Tie suggestion with hearts full of Christian love and fairness!",
            "Draw offered with the gentleness Christ teaches us to show!",
            "Stalemate proposal showing the patience and kindness of God!",
            "Tie suggested with the spirit of peace God gives!",
            "Draw offered with gratitude for a good, fair game together!",
            "Stalemate proposal made with the love Jesus shows to all!"
        ],

        stalemate: [
            "Stalemate achieved with good sportsmanship and Christian love!",
            "Draw reached showing that fairness and kindness won the day!",
            "Tie result with gratitude for a game well played together!",
            "Stalemate showing the beauty of playing with honor and respect!",
            "Draw concluded with thankfulness for good competition and friendship!",
            "Tie result showing the grace and fairness God wants in all we do!",
            "Stalemate reached with hearts full of gratitude and good sportsmanship!",
            "Draw achieved showing the peace that comes from playing with integrity!",
            "Tie concluded with praise for the wisdom and kindness shown!",
            "Stalemate result showing the beauty of Christian love in competition!"
        ],

        botCapture: [
            "Captured your piece with gratitude for the strategy God provides!",
            "Taking your piece with thankfulness for the wisdom to see ahead!",
            "Piece captured through the strategic gifts God has given!",
            "Your piece taken with humble thanks for mental blessings received!",
            "Captured with joy for the opportunity to use our minds well!",
            "Taking your piece with gratitude for the patience God teaches!",
            "Piece captured through wisdom and careful, prayerful planning!",
            "Your piece taken with thanks for the guidance God provides!",
            "Captured with appreciation for the gifts of thought and strategy!",
            "Taking your piece with humble gratitude for God's daily help!",
            "Piece captured through the understanding God gives freely!",
            "Your piece taken with praise for the wisdom from above!",
            "Captured with thankfulness for the mind God has given!",
            "Taking your piece with gratitude for strategic blessings!",
            "Piece captured through the wonderful gifts God shares with us!"
        ],

        humanCheck: [
            "Check given! You're thinking ahead like Joseph planning for Egypt!",
            "Your check shows wisdom and the strategic mind God has given you!",
            "Check delivered! That's smart thinking guided by God's gifts!",
            "Your check shows the patience and planning God blesses!",
            "Check given with skill! God has blessed you with strategic thinking!",
            "Your check shows wisdom like Daniel in the king's court!",
            "Check delivered! That's the kind of forward thinking God loves!",
            "Your check shows the mental gifts God has graciously given!",
            "Check given! Like Nehemiah planning the wall - thinking ahead!",
            "Your check shows the strategic wisdom God provides those who ask!",
            "Check delivered with skill showing God's gift of intelligence!",
            "Your check shows careful planning like the wise master builder!",
            "Check given! That's using the mind God has blessed you with!",
            "Your check shows wisdom and the patience God teaches us!",
            "Check delivered! God has given you real gifts for strategic thinking!"
        ],

        botCheck: [
            "Check! Trusting God's wisdom helped me see this opportunity!",
            "CHECK given through the strategic gifts God provides!",
            "Check delivered with thankfulness for the wisdom from above!",
            "CHECK! God's guidance helped me plan this move ahead!",
            "Check given with gratitude for the mind God has blessed!",
            "CHECK through the patience and planning God teaches us!",
            "Check delivered! Praise God for the strategic thinking He gives!",
            "CHECK with humble thanks for the wisdom God provides daily!",
            "Check given through the understanding that comes from God!",
            "CHECK! God's help guided this strategic opportunity perfectly!",
            "Check delivered with praise for the gifts of thought and planning!",
            "CHECK through the wonderful wisdom God shares with us!",
            "Check given with gratitude for God's guidance in strategy!",
            "CHECK! Thankful for the mental blessings God provides!",
            "Check delivered through the strategic gifts from our loving God!"
        ],
        ...
        humanWins: [
            ...
            "You won! Like David defeating Goliath with God's help and wisdom!",
            "Congratulations! You played with the wisdom God delights to give!",
            "Well played! Your victory shows the fruit of patient, careful thinking!",
            "You won with honor! God loves when we use our gifts with integrity!",
            "Congratulations! You showed the strategic wisdom God provides!",
            "Well done! Your win came through the gifts God has blessed you with!",
            "You won! May God continue to bless the wisdom He's given you!"
        ],
        ...
        botWins: [
            ...
            "Victory achieved with praise for God's daily mercies and help!",
            "Game won through the wonderful gifts God shares with us!",
            "Victory with humble thanks for God's guidance and wisdom!",
            "Game won with gratitude for the strategic mind God has given!",
            "Victory achieved through the patience and planning God blesses!",
            "Game won with praise for the wisdom God gives to those who ask!",
            "Victory through the amazing gifts our loving God provides!"
        ],

        // Filler reactions for regular moves
        filler: [
            "Hmm...", "I see", "Interesting", "Good thinking", "Nice move", "Well done",
            "*reading Bible verse*", "*saying little prayer*", "*thinking prayerfully*", "*counting blessings*",
            "God is good", "Blessed day", "Wonderful", "Amazing", "Praise God", "Thank you Lord",
            "*humming hymn*", "*thinking of Psalm 23*", "*remembering God's love*", "*grateful heart*",
            "Faith hope love", "God's plan", "Trust Him", "He's faithful", "All things work together",
            "*thinking of Bible stories*", "*remembering Jesus' love*", "*grateful for today*",
            "John 3:16", "Philippians 4:13", "Psalm 23:1", "Proverbs 3:5", "Matthew 5:16",
            "Jesus loves me", "God loves you", "We are blessed", "Give thanks", "Pray always",
            "*quiet prayer*", "*thankful thoughts*", "*remembering God's goodness*", "*trusting God*",
            "Love one another", "Be kind", "Show mercy", "Share joy", "Give hope",
            "God's children", "Heaven bound", "Grace sufficient", "Peace that passes understanding",
            "*singing softly*", "*whispering praise*", "*heart full of joy*", "*thankful spirit*",
            "Fruit of the Spirit", "Walking with Jesus", "Growing in grace", "Learning love",
            "God's gifts", "Daily bread", "Seek first", "Ask seek knock", "Come unto me",
            "*thinking of family*", "*praying for friends*", "*grateful for church*", "*loving others*"
        ]
    }
};
